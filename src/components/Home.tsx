        ...
        <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)]">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto mb-8">
              Combino el poder de Flutter con buenas prácticas de ciberseguridad para crear aplicaciones móviles seguras de alto rendimiento y escalables
            </p>
            ...
            >
              ...
              >
                <Youtube size={40} className="text-red-500 group-hover:text-yellow-500 transition-colors" />
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/projects" className="btn-primary flex items-center justify-center gap-2">
                Ver Mis Proyectos <ArrowRight size={20} />
              </Link>
              <Link 
                to="/contact" 
